...
public class GroupMessage extends RecyclerView.Adapter<GroupMessage.MessageViewHolder> {
    ...
    public GroupMessage(Context context, List<com.chatelite.models.Message> userMessagesList) {
    ...
    public class MessageViewHolder extends RecyclerView.ViewHolder {
        public TextView senderMessageText, receiverMessageText, sentTime, secondSentTime, messagesDate, theFirstMessageSender, theSecondMessageSender;
            ...
            if (fromUserID.equals(messageSenderId)) {
                ...
                UsersRef.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            messageViewHolder.theFirstMessageSender.setText(senderName);
                    }
