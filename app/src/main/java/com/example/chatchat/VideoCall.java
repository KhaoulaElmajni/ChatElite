...
public class VideoCall extends AppCompatActivity {
    private static final String TAG = MainActivityy.class.getSimpleName();
    ...
    private MainActivityy.CallState _callState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _callState = MainActivityy.CallState.TERMINATED;
        ...
        _peer.on(Peer.PeerEventEnum.CALL, new OnCallback() {
            ...
            public void onCallback(Object object) {
                ...
                _callState = MainActivityy.CallState.CALLING;
        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (MainActivityy.CallState.TERMINATED == _callState) {

                    // Select remote peer & make a call
                    showPeerIDs();
                } else if (MainActivityy.CallState.CALLING == _callState) {
    ...
    void setMediaCallbacks() {
        ...
        _mediaConnection.on(MediaConnection.MediaEventEnum.STREAM, new OnCallback() {
            ...
            public void onCallback(Object object) {
                ...
                _callState = MainActivityy.CallState.ESTABLISHED;
                updateActionButtonTitle();
            }
        });
